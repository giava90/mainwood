...
git pull
python -m pytest ../                              # 265 tests, ~15 s
...
code/                       the pipeline
  ...
  summaries_to_parquet.py   convert old CSV summaries to Parquet
  diagnose_summary.py       what a summary holds, in m3/ha/yr
...
tests/       265 pytest tests, pure Python, ~15 s
