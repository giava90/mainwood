...
public class BaumschaftformFkt_Lfi_Spline extends BaumSchaftformFunktion {
	...
	public double getDurchmesser_iR_cm(BaumschaftDefinition bsDef, double messHoehe_m) {
		// 1. Berechne 9 St�tzstellen am Baumschaft
		...
		// 2. Berechne Kr�mmung in H�he 1m
...
//		for (int i=0; i<9; i++) {
//			System.out.println( "Stuetzstelle in H�he " + DurchmesserKoeffizienten.StuetzstellenHoehe.values()[i] + " = " + stuetzStellen[DurchmesserKoeffizienten.StuetzstellenHoehe.values()[i].ordinal()] );
//		}
//		System.out.println( "Kr�mmung in H�he 1m = " + kruemmung1m);
//
//		System.out.println("Hoehe der St�tzstelle  1m = " + 1);
//		System.out.println("Hoehe der St�tzstelle  5% = " + 0.05 * bsDef.getSchaftLaenge_m());
//		System.out.println("Hoehe der St�tzstelle 10% = " + 0.10 * bsDef.getSchaftLaenge_m());
//		System.out.println("Hoehe der St�tzstelle 20% = " + 0.20 * bsDef.getSchaftLaenge_m());
//		System.out.println("Hoehe der St�tzstelle 30% = " + 0.30 * bsDef.getSchaftLaenge_m());
//		System.out.println("Hoehe der St�tzstelle 50% = " + 0.50 * bsDef.getSchaftLaenge_m());
//		System.out.println("Hoehe der St�tzstelle 70% = " + 0.70 * bsDef.getSchaftLaenge_m());
//		System.out.println("Hoehe der St�tzstelle 80% = " + 0.80 * bsDef.getSchaftLaenge_m());
		...
		if ( Math.abs(bsDef.getSchaftLaenge_m() - 20.0) <= 2 ) { //Korrektur bei Schaftl�nge 20m: Auslassen der 1. St�tzstelle
		...
		else if ( Math.abs(bsDef.getSchaftLaenge_m() - 10.0) <= 2 ) { //Korrektur bei Schaftl�nge 10m: Auslassen der 2. St�tzstelle
		...
		else if ( Math.abs(bsDef.getSchaftLaenge_m() - 5.0) <= 2 ) { //Korrektur bei Schaftl�nge 5: Auslassen der 3. St�tzstelle
